...
def upgrade():
    ...
    indexes = [
        'idx_employee_salary_code', 'idx_wage_master_salary_code', 'idx_wage_master_site_name',
        'idx_deduction_employee_id', 'idx_deduction_employee_active', 'idx_attendance_employee_date_status'
    ]
    for idx in indexes:
        try:
